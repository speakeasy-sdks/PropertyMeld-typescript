...
export class ProjectListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ProjectListRequest extends SpeakeasyBase {
    /**
...
export class ProjectListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
