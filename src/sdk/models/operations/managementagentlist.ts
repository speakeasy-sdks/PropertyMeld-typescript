...
export class ManagementAgentListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ManagementAgentListRequest extends SpeakeasyBase {
    /**
...
export class ManagementAgentListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
