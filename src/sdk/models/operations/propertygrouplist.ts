...
export class PropertyGroupListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class PropertyGroupListRequest extends SpeakeasyBase {
    /**
...
export class PropertyGroupListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
