...
export class ExpenditureRetrieveSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ExpenditureRetrieveRequest extends SpeakeasyBase {
    /**
...
export class ExpenditureRetrieveResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
