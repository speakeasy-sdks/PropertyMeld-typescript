...
export class MeldVendorFilesListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class MeldVendorFilesListRequest extends SpeakeasyBase {
    /**
...
export class MeldVendorFilesListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
