...
export class ManagerFileListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ManagerFileListRequest extends SpeakeasyBase {
    /**
...
export class ManagerFileListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
