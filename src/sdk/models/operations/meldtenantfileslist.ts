...
export class MeldTenantFilesListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class MeldTenantFilesListRequest extends SpeakeasyBase {
    /**
...
export class MeldTenantFilesListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
