...
export class BuildingListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class BuildingListRequest extends SpeakeasyBase {
    /**
...
export class BuildingListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
