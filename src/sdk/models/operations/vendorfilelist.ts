...
export class VendorFileListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class VendorFileListRequest extends SpeakeasyBase {
    /**
...
export class VendorFileListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
