...
export class WorkLogListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class WorkLogListRequest extends SpeakeasyBase {
    /**
...
export class WorkLogListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
