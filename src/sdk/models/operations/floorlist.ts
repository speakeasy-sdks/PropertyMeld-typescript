...
export class FloorListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class FloorListRequest extends SpeakeasyBase {
    /**
...
export class FloorListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
