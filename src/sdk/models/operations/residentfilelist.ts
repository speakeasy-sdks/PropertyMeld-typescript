...
export class ResidentFileListSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ResidentFileListRequest extends SpeakeasyBase {
    /**
...
export class ResidentFileListResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
