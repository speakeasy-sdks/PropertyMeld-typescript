...
export class MeldSerializerDetailManagementAgentCloser extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class MeldSerializerDetailManagementappointment extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class MeldSerializerDetailManagerCanceller extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "agent_preferences" })
    agentPreferences: number;
...
export class MeldSerializerDetailMeldExpenditures extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "amount" })
    amount?: string;
...
export class MeldSerializerDetailVendorCloser extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "address" })
    address: number;
...
export class MeldSerializerDetailVendorappointment extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class MeldSerializerDetailOutput extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @Type(() => MeldSerializerDetailManagementAgentCloser)
    managementAgentCloser: MeldSerializerDetailManagementAgentCloser;

    @SpeakeasyMetadata()
    @Expose({ name: "managementappointment" })
    @Type(() => MeldSerializerDetailManagementappointment)
    managementappointment: MeldSerializerDetailManagementappointment;
    ...
    @Type(() => MeldSerializerDetailManagerCanceller)
    managerCanceller: MeldSerializerDetailManagerCanceller;
    ...
    @Type(() => MeldSerializerDetailMeldExpenditures)
    meldExpenditures: MeldSerializerDetailMeldExpenditures;
    ...
    @Type(() => MeldSerializerDetailVendorCloser)
    vendorCloser: MeldSerializerDetailVendorCloser;

    @SpeakeasyMetadata()
    @Expose({ name: "vendorappointment" })
    @Type(() => MeldSerializerDetailVendorappointment)
    vendorappointment: MeldSerializerDetailVendorappointment;
